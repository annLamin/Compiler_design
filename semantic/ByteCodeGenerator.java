...
public class ByteCodeGenerator extends ASTVisitor {
  ...
  public Object visitWhileStatement(ASTWhileStatement whileStatement,
    ...
    as(-1);
    emt("\t\t; while statement");
    BeginEnd be = new BeginEnd(lstart, lend);
    whileStatement.statement.accept(this, be);
    emt("goto " + lstart);
    eml(lend);
    emt("\t\t; end while");
    m.d();
  ...
  public Object visitDoWhileStatement(
		  ASTDoWhileStatement dow, Object o) {
	
		  emt("\t\t; start while");
		  emt("\t\t; do while statement");
		  String lstart = label();
		  String lend = label();
		  eml(lstart);
		  dow.statement.accept(this, null);
		  dow.expression.accept(this, null);
		  emt("ifeq " + lend);
		  as(-1);
		  emt("\t\t; do while condition");
		  emt("goto " + lstart);
		  eml(lend);
		  emt("\t\t; end do while");
		  return null;
  ...
  public Object visitBreakStatement(
		  ASTBreakStatement bre, Object o) {
	  	  m.verbose("> break");
	  	  BeginEnd be = (BeginEnd) o;
//          emt("goto " + be.b +" \t; break"); // exception on this line	  
          return null;
  }
  
  public Object visitContinueStatement(
		  ASTContinueStatement bre, Object o) {
	      m.verbose("continue");
	      BeginEnd be = (BeginEnd) o;
          emt("goto " + be.e +" \t; continue");	  
          return null;
}
}
