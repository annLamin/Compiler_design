...
public class ComputeReachableCode extends ASTVisitor {
  ...
  public Object visitDoWhileStatement(
		  ...
		  boolean reachable = (Boolean) o;
		  if (!reachable) {
		  m.error("unreachable statement at " + dow.position + "\n" + dow);
		  }
		  // a do while statement contains a return statement if its
		  // statement contains a return statement
		  return dow.statement.accept(this, reachable);
		  }
}
